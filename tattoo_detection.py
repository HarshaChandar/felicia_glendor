...
def getData():
    ...
    train_data = datasets.ImageFolder(os.path.join(root, 'closeup'), transform=train_tranform)
    test_data = datasets.ImageFolder(os.path.join(root, 'closeup'), transform=test_transform)
